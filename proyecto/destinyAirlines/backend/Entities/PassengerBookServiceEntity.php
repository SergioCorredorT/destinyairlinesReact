...
class PassengerBookServiceEntity {
    private $id_PASSENGERS_BOOKS_SERVICES;
    private $id_PASSENGERS;
    private $id_BOOKS;
    private $id_SERVICES;

    public function __construct($params = []) {
        $this->id_PASSENGERS_BOOKS_SERVICES = $params['id_PASSENGERS_BOOKS_SERVICES'] ?? null;
    ...
    public function getId_PASSENGERS_SERVICES() {
        return $this->id_PASSENGERS_BOOKS_SERVICES;
    }
    ...
    public function setId_PASSENGERS_SERVICES($value) {
        $this->id_PASSENGERS_BOOKS_SERVICES = $value;
    }
