...
ALTER TABLE `SERVICES_INVOICES` ADD FOREIGN KEY (`id_INVOICES`) REFERENCES `INVOICES` (`id_INVOICES`);

ALTER TABLE `SERVICES_INVOICES` ADD FOREIGN KEY (`id_SERVICES`) REFERENCES `SERVICES` (`id_SERVICES`);

ALTER TABLE `SERVICES_INVOICES` ADD FOREIGN KEY (`id_PASSENGERS`) REFERENCES `PASSENGERS` (`id_PASSENGERS`);
...
ALTER TABLE `PASSENGERS` ADD FOREIGN KEY (`id_BOOKS`) REFERENCES `BOOKS` (`id_BOOKS`);
